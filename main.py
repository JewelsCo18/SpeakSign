...
def translate_to_letter(colorCoord, calculations):
    ...
    minCoordVals = {
        ...
        'C': [-25, -125, -270, -190, -400, 130, 30,-30, -60, 150],
        'D': [0,-192,0, 176, 23, 8, 17, -5, -88, -120],
        'E': [-40,-75,30,-5,0,-10,20,-25,-90,50],
        'F': [10,-77,-40, -130, 20, 0,30, 10, -70, 160],
        ...
        'P': [-78, 56, 93, 48, -419, -312, -82, -14, -431, -304], 
        'Q': [-45, -20, -451, -205, 0, 0, 110, 1, -466, -110],
        'R': [-21, -124, -31, -43, -12, 128, 16, 2, -54, -73],
        'S': [19, 65, 23, -8, 33, -9, 32, -52, -139, -78],
        'T': [-4, 68, 24, 16, 27, -19, 23, -52, -98, -64],
        'U': [-73, -197, 30, -24, -46, 70, 18, 2, -15, -126],  
        'V': [-53, -241, 72, -10, -64, 239, 29, -48, -51, -37],
        'W': [-87, -181, 44, -60, 40, 13, -55, 168, -7, -36], 
        'X': [0, -152, -449, -147, 360, 211, 39, -35, -105, -26],
    ...
    maxCoordVals = {
        ...
        'C': [5,-100, 10, -40,400, 190,50,10, 0, 160],
        'D': [35, -120, 20, 230, 42, 31, 41, 10, 5, -80],
        'E': [-20,-45,50,30,30,40,65,5,-50,80],
        'F': [40, -58, -25, 160, 60, 20, 65, 40,0, 200],
        ...
        'P': [320, 239, 110, 58,  -27, -50, 624, 438, 79, -42], 
        'Q': [451, 296, -289, -101, 0, 0, 466, 111, -110, -1],
        'R': [30, -81, 10, 27, 32, 237, 33, 22, -3, -58],
        'S': [34, 92, 37, -1, 48, -1, 48, -12, -119, -27], 
        'T': [-4, 91, 39, 25, 46, -3, 45, -17, -71, -53], 
        'U': [-46, -136, 75, 167, -2, 289, 35, 25, 6, -92],  
        'V': [-27, -190, 110, 8, -13.5, 302, 36, -6, -35, 1],
        'W': [-64, -107, 68, -8, 67, 35, -17, 194, 1, -25],
        'X': [17, -123, -327, -55, 463, 322, 70, 6, -70, -8],
